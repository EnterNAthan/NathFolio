...
const CategoryIcons = {
  ...
  "Développement & Automatisation": (
    <svg
      ...
      className="w-6 h-6 text-[var(--sec)] opacity-70"
    >
<path xmlns="http://www.w3.org/2000/svg" d="M5.5 8C6.88071 8 8 6.88071 8 5.5C8 4.11929 6.88071 3 5.5 3C4.11929 3 3 4.11929 3 5.5C3 6.88071 4.11929 8 5.5 8ZM5.5 8V16M5.5 16C4.11929 16 3 17.1193 3 18.5C3 19.8807 4.11929 21 5.5 21C6.88071 21 8 19.8807 8 18.5C8 17.1193 6.88071 16 5.5 16ZM18.5 8C19.8807 8 21 6.88071 21 5.5C21 4.11929 19.8807 3 18.5 3C17.1193 3 16 4.11929 16 5.5C16 6.88071 17.1193 8 18.5 8ZM18.5 8C18.5 8.92997 18.5 9.39496 18.3978 9.77646C18.1204 10.8117 17.3117 11.6204 16.2765 11.8978C15.895 12 15.43 12 14.5 12H8.5C6.84315 12 5.5 13.3431 5.5 15"/>    </svg>
  ),
  "Sécurité Réseau & Blue Team": (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
const SkillsList = () => {
  ...
  const skills = {
   "Web Hacking & Bug Bounty": [
      "Exploitation des failles Web (XSS, SQLi, SSRF, etc.)",
      "CTF d’intrusion réseau (LAN, WiFi, Active Directory)",
      "Bug Bounty sur HackerOne & TryHackMe",
    ],
    "Développement & Automatisation": [
      "Scripts d’automatisation (Python, Bash, PowerShell)",
      "Développement de tools pour le pentest",
      "Développement de diverse projet web et en langage bas niveau.",
    ],
    "Sécurité Réseau & Blue Team": [
      "Analyse de trafic réseau avec Wireshark",
      "Détection et réponse aux incidents (SOC, SIEM)",
      "Configuration et durcissement des firewalls",
    ],
  };
